...
const principles = [
  ...
  },
  {
    ...
    title: 'Security im Datenmodell, nicht als Layer.',
    text: 'Rechte, Rollen und Audit-Logs gehören in die Datenbank — nicht in den API-Layer darüber. Was die Datenbank nicht freigibt, kann kein Frontend umgehen.',
    proof: 'Event Hub · RLS auf jeder Tabelle, nicht nur im Router',
    href: '#project-event-hub',
  },
  {
    icon: Zap,
    label: '03 · Realität prüfen',
    title: 'Erst deployen wenn der Admin steht.',
    text: 'Ein Feature das der Betreiber nicht konfigurieren, debuggen oder abschalten kann, ist kein Feature — es ist ein Risiko. Production-Readiness beginnt im Backend-Panel.',
    proof: 'DLD 3D · 3 Admin-Seiten vor dem Go-Live',
